...
// 	protoc        v4.24.4
// source: server_stream_rpc.proto
...
func (x *StreamResponse) Reset() {
	*x = StreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_server_stream_rpc_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamResponse) Descriptor() ([]byte, []int) {
	return file_server_stream_rpc_proto_rawDescGZIP(), []int{2}
}
...
var file_server_stream_rpc_proto_rawDesc = []byte{
	0x0a, 0x17, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f,
	0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x69, 0x6d,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x33, 0x0a, 0x0e, 0x53, 0x74,
	...
	0x6c, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x09, 0x5a,
...
var file_server_stream_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_server_stream_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_server_stream_rpc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
